Public Class Bundles
    ...
    Private Sub Label5_Click(sender As Object, e As EventArgs) Handles lblPasta.Click
        Dim obj = New Pasta
        obj.Show()
        Me.Hide()
    End Sub

    Private Sub lblBundle_Click(sender As Object, e As EventArgs) Handles lblBundle.Click
        Dim obj = New Bundles
        obj.Show()
        Me.Hide()
