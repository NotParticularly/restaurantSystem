Public Class Pasta
    ...
    Private Sub Label5_Click_1(sender As Object, e As EventArgs) Handles lblPasta.Click
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            paymentfunction.pizza1 = 320
            paymentfunction.order = "Lasagna Supreme Solo"
    ...
    Private Sub Pasta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If cbQty2.Text = "" Then
            MsgBox("Please specify the quantity.")
        Else
            paymentfunction.pizza1 = 250
            paymentfunction.order = "Creamy Bacon Carbonara Solo"
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Else
            ...
            paymentfunction.order = "Meaty Spaghetti Solo"
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        If cbQty4.Text = "" Then
            MsgBox("Please specify the quantity.")
        Else
            paymentfunction.pizza1 = 199
            paymentfunction.order = "Lasagna Supreme Pan"
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Else
            paymentfunction.pizza1 = 199
            paymentfunction.order = "Creamy Bacon Carbonara Pan"
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        ...
        Else
            paymentfunction.pizza1 = 109
            paymentfunction.order = "Creamy Shrimp Spaghetti Solo"
